/*
09 - Escreva um programa que permita ao usuário escolher uma faixa de salário (1
para até R$ 2.000, 2 para de R$ 2.000 a R$ 5.000, 3 para acima de R$ 5.000) e
informe o valor do salário bruto. Utilize um switch para calcular o valor do
